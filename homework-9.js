...
//     return false;
//   }
//     return movies.includes(Gladiator);
// }
...
// console.log('Задание 3 (функция, некорректный параметр):', checkMovieExists(123));
...
console.log('Задание 7 (функция, не массив):', filterCommentsByDomain('не массив', '.com'));
console.log('Задание 7 (функция, не строка):', filterCommentsByDomain(comments, 123));
